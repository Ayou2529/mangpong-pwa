/**
 * อัปเดตโค้ดใน index.html หรือ main.js
 * แทนที่ฟังก์ชัน submitToGoogleSheets เดิมด้วยโค้ดด้านล่าง
 */
    ...
    try {
      ...
      setTimeout(() => {
        if (window[callbackName]) {
          delete window[callbackName];
          const timeoutScript = document.getElementById('jsonp-script');
