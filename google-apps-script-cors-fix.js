...
function handleLogin(params) {
  ...
  const sheet = SpreadsheetApp.openById('1fcq5P7vm3IxtJMDS9BLDwO8B14hFmmDdK257GHyoM').getSheetByName('Users');
...
function handleCreateJob(params) {
  const sheet = SpreadsheetApp.openById('1fcq5P7vm3IxtJMDS9BLDwO8B14hFmmDdK257GHyoM').getSheetByName('Jobs');
